...
train_text = "Withdrawal has Withdrawalamount, Withdrawaldate, Withdrawaltime, Withdrawaltype."      #text used to train the PunktSentenceTokenizer
sample_text = "Withdrawal has Withdrawalamount, Withdrawaldate, Withdrawaltime, Withdrawaltype."     #text on which PunktsentenceTokenizer is applied after training it.
