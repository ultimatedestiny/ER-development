...
train_text = "This is a medical store."      #text used to train the PunktSentenceTokenizer
sample_text = "This is a medical store."     #text on which PunktsentenceTokenizer is applied after training it.
